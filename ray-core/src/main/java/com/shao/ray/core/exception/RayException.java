package com.shao.ray.core.exception;
...
public class RayException extends RuntimeException {
	...
	protected RayException(int friendlyCode, String friendlyMsg, String urlPath) {
		this.setValues(friendlyCode, friendlyMsg, urlPath);
	}

	public RayException(RayExceptionEnum bizExceptionEnum) {
