...
public class ContextConfig {
    ...
    private String templatePrefixPath = "rayTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\ray";//模板输出的项目目录
    ...
    private String modelPackageName = "com.shao.ray.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.shao.ray.common.persistence.dao";  //model的dao
