package com.shao.ray.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.shao.ray.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.servicePathTemplate = "\\src\\main\\java\\com\\shao\\ray\\modular\\" + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\com\\shao\\ray\\modular\\" + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "com.shao.ray.modular." + contextConfig.getModuleName() + ".service";
    }
