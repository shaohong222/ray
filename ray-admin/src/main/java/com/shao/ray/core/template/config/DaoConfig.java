...
public class DaoConfig {
    ...
    public void init() {
        this.daoPathTemplate = "\\src\\main\\java\\com\\shao\\ray\\modular\\" + contextConfig.getModuleName() + "\\dao\\{}Dao.java";
        this.xmlPathTemplate = "\\src\\main\\java\\com\\shao\\ray\\modular\\" + contextConfig.getModuleName() + "\\dao\\mapping\\{}Dao.xml";
        this.packageName = "com.shao.ray.modular." + contextConfig.getModuleName() + ".dao";
    }
